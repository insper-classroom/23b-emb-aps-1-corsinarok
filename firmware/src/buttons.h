 ...
 * @file buttons.h 
 * 
 * @brief Arquivo com as defini��es dos botoes.
*/
...
#define PAUSE_BUT_PIO_ID       ID_PIOA                  // ID do perif�rico do botao de pausar/retomar a musica
...
#define SELECTION_BUT_PIO_ID    ID_PIOD                  // ID do perif�rico do botao de selecionar a musica
